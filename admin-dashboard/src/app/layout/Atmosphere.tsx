...
export function Atmosphere() {
  return (
    <div aria-hidden="true" className="pointer-events-none fixed inset-0 overflow-hidden">
      ...
      <div className="mesh-drift absolute top-[30%] -right-52 h-[520px] w-[520px] rounded-full opacity-55 blur-[90px] [animation:drift-b_32s_ease-in-out_infinite] [background:radial-gradient(circle_at_60%_40%,var(--color-accent-light),transparent_70%)]" />
      <div className="mesh-drift absolute -bottom-48 left-[20%] h-[460px] w-[460px] rounded-full opacity-55 blur-[90px] [animation:drift-c_30s_ease-in-out_infinite] [background:radial-gradient(circle_at_50%_50%,#1c3aa8,transparent_72%)]" />
    </div>
  );
}
