...
/**
 * The real, security-relevant behavior this pins down: admin-dashboard/README.md
 * claims "a role that can't use a screen has that nav item hidden entirely
 * rather than shown and left to 403" — this test renders the real `Sidebar`
 * against the real `useAuthStore` (not a mocked module) for each role and
 * checks exactly that.
 */
