...
export function EmployeesListPage() {
  ...
  // Debounced so every keystroke doesn't fire a request — 350ms is short
  // enough to feel live, long enough to not spam the API mid-word.
  useEffect(() => {
      ...
      <Reveal index={1}>
        <Card className="flex flex-wrap items-center gap-3 px-5 py-4">
          <input
            ...
            className="min-w-[220px] flex-1 rounded-xl border border-border bg-white/[0.03] px-3.5 py-2.5 text-[14px] text-text placeholder:text-text-faint focus:border-accent-light focus:bg-accent/[0.06] focus:outline-none"
          />
          <Select
