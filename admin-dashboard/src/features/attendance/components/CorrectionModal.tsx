...
/** `PATCH /attendance/:id/correct` — a direct HR/Admin edit, no approval step (distinct from the employee-initiated request/approve/reject flow this same screen also surfaces). Mandatory `reason`, audit-logged server-side. */
