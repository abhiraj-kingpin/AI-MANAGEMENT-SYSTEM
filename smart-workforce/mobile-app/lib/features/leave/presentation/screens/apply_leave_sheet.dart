...
class _ApplyLeaveSheetState extends ConsumerState<ApplyLeaveSheet> {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _reviewing ? _buildReview(context) : _buildForm(context),
        ],
      ),
    );
  }
  ...
  Widget _buildForm(BuildContext context) {
    ...
    return Form(
      ...
      child: Column(
        ...
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
          Text('Apply for Leave', style: WPText.sans(size: 18, weight: FontWeight.w800)),
          const SizedBox(height: 16),
          ...
          if (_errorMessage != null) ...[
            ...
            Text(_errorMessage!, style: WPText.sans(size: 12.5, color: WPColors.danger)),
          ],
          const SizedBox(height: 8),
          WPButton(label: 'Review Request', onPressed: _goToReview),
        ],
      ),
    );
  }
  ...
  Widget _buildReview(BuildContext context) {
    return Column(
      ...
      crossAxisAlignment: CrossAxisAlignment.stretch,
      children: [
        Text('Confirm Leave Request', style: WPText.sans(size: 18, weight: FontWeight.w800)),
        const SizedBox(height: 16),
        WPCard(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              Text('Reason', style: WPText.sans(size: 11.5, weight: FontWeight.w700, color: WPColors.textDim)),
              const SizedBox(height: 4),
              Text(_reasonController.text.trim(), style: WPText.sans(size: 13, weight: FontWeight.w500)),
            ],
          ),
        ),
        if (_errorMessage != null) ...[
        ...
        Row(
          children: [
            Expanded(
              child: InkWell(
                onTap: _isSubmitting ? null : () => setState(() => _reviewing = false),
                ...
                child: Container(
                  ...
                  child: Text('Edit', style: WPText.sans(size: 14.5, weight: FontWeight.w700)),
                ),
              ),
            ),
            const SizedBox(width: 12),
            Expanded(
              child: WPButton(label: 'Submit', isLoading: _isSubmitting, onPressed: _submit),
            ),
          ],
        ),
      ],
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Text(label, style: WPText.sans(size: 12.5, weight: FontWeight.w500, color: WPColors.textDim)),
          Text(value, style: WPText.sans(size: 12.5, weight: FontWeight.w700)),
        ],
      ),
    );
  }
