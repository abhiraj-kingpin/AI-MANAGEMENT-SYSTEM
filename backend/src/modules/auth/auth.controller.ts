...
// Scoped to /auth so the cookie is never sent on unrelated API calls.
...
/** Web sends the refresh token via its httpOnly cookie; mobile sends it in the body (see mobile-app/lib/core/network/dio_client.dart). */
