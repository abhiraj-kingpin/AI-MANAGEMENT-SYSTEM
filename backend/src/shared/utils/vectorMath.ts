 ...
 * practice [0, 1] for face embeddings, which are non-negative-normalized by
 * most models). This is the actual face-matching math — real and tested,
 * independent of whatever produced the vectors.
 */
...
/** Returns the highest similarity among a set of candidate vectors, or 0 if there are none. */
