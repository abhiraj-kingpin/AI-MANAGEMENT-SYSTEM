...
/**
 * Covers only what rejects before touching the database — validation and
 * route-level RBAC gates — same DB-free approach as the auth/employees route
 * wiring suites. Business logic lives in attendance.service.test.ts.
 */
