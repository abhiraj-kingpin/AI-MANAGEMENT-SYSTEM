...
// 2026-08-10 is a Monday, 2026-08-16 is a Sunday — a full calendar week
// used as the baseline range throughout.
...
describe('countBusinessDays', () => {
  it('matches the length of listBusinessDays for the same range', () => {
    ...
    const end = new Date('2026-08-21'); // two full weeks
