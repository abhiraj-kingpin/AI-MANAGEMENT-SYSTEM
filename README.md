...
| -------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| [`backend/`](backend/)                 | 16 of 20 roadmap phases complete — authentication through security hardening. See [backend/README.md](backend/README.md) for the full feature list and API reference. | 499 Jest tests passing, `lint`/`typecheck`/`build` clean, no live database required                                             |
