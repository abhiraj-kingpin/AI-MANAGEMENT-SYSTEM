...
class FaceRepositoryImpl implements FaceRepository {
  ...
  Future<Result<FaceRegisterResultEntity>> registerEmbeddings(
    ...
    try {
      ...
      // No offline queue for registration, unlike check-in — re-registering
      // an unreliable connection is something the user should explicitly
      // retry, not something silently replayed later against whatever
      // embeddings happened to be captured in that attempt.
